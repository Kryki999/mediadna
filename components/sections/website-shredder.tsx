...
export function WebsiteShredder() {
  useEffect(() => {
    ...
    return () => {
      const w = window as Window & {
        ...
        setScannerScanning?: ((active: boolean) => void) | undefined
      }
  ...
  return (
    <section className="relative bg-black pb-2 pt-6 md:pb-4 md:pt-11">
      ...
      <div className="relative mt-6 w-full overflow-hidden bg-black md:mt-8">
